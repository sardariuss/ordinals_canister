...
impl IsService for ServiceHiroInscriptionContent {
    ...
    fn get_url(&self, args: Args) -> String {
        let inscription_id = match args.function {
            OrdFunction::InscriptionContent{ inscription_id } => inscription_id,
...
fn test_build_request() {
    ...
    let args = Args {
        function: OrdFunction::InscriptionContent{ inscription_id: "38c46a8bf7ec90bc7f6b797e7dc84baa97f4e5fd4286b92fe1b50176d03b18dci0".to_string() },
        query_options: None,
